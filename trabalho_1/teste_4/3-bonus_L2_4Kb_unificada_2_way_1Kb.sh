...
# cache unificada nível 1 (1Kb) e cache unificada nível 2 (4Kb)
dados1="-cache:dl1 ul1:32:16:2:r"
dados2="-cache:dl2 ul2:64:32:2:r"

# definindo cache il1 = dl1 (unificada) e ausência cache il2
instr1="-cache:il1 dl1"
